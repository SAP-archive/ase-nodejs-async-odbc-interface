...
void ODBCConnection::Init(v8::Handle<Object> exports) {
  ...
  // Prototype Methods
  Nan::SetPrototypeMethod(constructor_template, "connect", Open);
  Nan::SetPrototypeMethod(constructor_template, "openSync", OpenSync);
  Nan::SetPrototypeMethod(constructor_template, "disconnect", Close);
  ...
  Nan::SetPrototypeMethod(constructor_template, "exec", Query);
